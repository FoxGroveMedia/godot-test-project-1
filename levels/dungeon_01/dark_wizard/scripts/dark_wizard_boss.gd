...
const ENERGY_EXPLOSION_SCENE : PackedScene = preload("res://levels/dungeon_01/dark_wizard/energy_explosion.tscn")
const ENERGY_ORB_SCENE : PackedScene = preload("res://levels/dungeon_01/dark_wizard/energy_orb.tscn")


@export var max_hp : int = 10
var hp : int = 10

var audio_hurt : AudioStream = preload("res://levels/dungeon_01/dark_wizard/audio/boss_hurt.wav")
var audio_shoot : AudioStream = preload("res://levels/dungeon_01/dark_wizard/audio/boss_fireball.wav")
...
func _ready() -> void:
	...
	for c in $PositionTargets.get_children():
		postions.append( c.global_position )
...
func teleport( _location : int ) -> void:
	...
	boss_node.global_position = postions[ _location ]
